						...
						<div className="row">
							...
							<form className="form-inline input-group mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
								...
								<div className="input-group mb-3 col-xs-12 col-sm-12 col-md-6 col-lg-6">
								  ...
								  <input type="text" className="form-control" placeholder="Verificar Email" aria-label="Username" aria-describedby="basic-addon1"/>
								</div>
							...
							<form className="form-inline input-group mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
								<div className="input-group mb-3 col-xs-12 col-sm-12 col-md-6 col-lg-6">
								  ...
								  <input type="text" className="form-control" placeholder="Nuevo Email" aria-label="Username" aria-describedby="basic-addon1"/>
								</div>
								...
								<div className="input-group mb-3 col-xs-12 col-sm-12 col-md-6 col-lg-6">
								  ...
								  <input type="text" className="form-control" placeholder="Verificar nuevo Email" aria-label="Username" aria-describedby="basic-addon1"/>
								</div>
